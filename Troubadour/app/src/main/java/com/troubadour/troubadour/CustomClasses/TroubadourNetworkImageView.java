 ...
 * associated request.
 */
public class TroubadourNetworkImageView extends AppCompatImageView{
    ...
    public TroubadourNetworkImageView(Context context) {
        this(context, null);
    }

    public TroubadourNetworkImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TroubadourNetworkImageView(Context context, AttributeSet attrs, int defStyle) {
